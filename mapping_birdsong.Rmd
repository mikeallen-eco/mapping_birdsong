---
title: "Mapping Birdsong"
author: "Mike Allen"
date: "1/31/2022"
output: html_document
---
# Load libraries and read in your data file
This code file is organized into discrete "chuClick the green arrow to run this code. Make sure there is only one file (the csv you downloaded from Macaulay Library) in the "my_raw_data" folder. Note that it only keeps songs with a known location (lattitude) and with a quality score of 4 or greater.
```{r}
